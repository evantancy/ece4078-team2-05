...
class YOLO:
    def __init__(
        self,
        weights_path: str = "cfg/custom-yolov4-detector_final.weights",
        cfg_path: str = "cfg/custom-yolov4-detector.cfg",
        classes_path: str = "cfg/obj.names",
    ) -> None:
        """
        Args:
            weights_path (str, optional): Defaults to "cfg/custom-yolov4-detector_final.weights".
            cfg_path (str, optional): Defaults to "cfg/custom-yolov4-detector.cfg".
            classes_path (str, optional): Defaults to "cfg/obj.names".
        """
    ...
    def draw_boxes(self, img=None) -> None:
